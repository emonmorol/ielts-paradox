...
public class CourseInfo {
    ...
    public CourseInfo(String _id, String title, String[] features, String thumbnail, int price, boolean isReleased, int discount, String[] curriculum, ArrayList<Faq> faqs, String details, String[] sidebarPoint, String instructorName,String routine,int messagePort) {
        this._id = _id;
        this.title = title;
